...
use App\Http\Controllers\Admin\LaporanPemesananController;
...
Volt::route('/pembayaran', 'landingpage.pembayaran.index')->middleware(['auth', 'verified'])->name('pembayaran');
...
Route::middleware(['auth', 'verified'])->prefix('admin')->name('admin.')->group(function () {
    ...
    Route::middleware('can:kelola_pemesanan')->group(function () {
        Route::get('pemesanan/laporan', LaporanPemesananController::class)->name('pemesanan.laporan');
