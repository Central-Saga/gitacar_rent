            ...
            <div class="border border-gray-100 rounded-lg p-5 bg-gray-50/50">
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                    ...
                    <div>
                        ...
                        <p class="text-xs text-textGray mt-1">Gunakan kombinasi huruf kapital dan angka tanpa spasi.</p>
                    </div>
                    ...
                    <div>
                        ...
                        <p class="text-xs text-textGray mt-1">Batas nilai maksimal yang dipotong. Biarkan kosong jika
