...
<link
  href="https://fonts.googleapis.com/css2?family=Noto+Sans:wght@400;500;700;900&family=Plus+Jakarta+Sans:wght@300;400;500;600;700&display=swap"
  rel="stylesheet">

<div class="text-slate-800">
  <!-- ===== CONTACT US CTA ===== -->
  <section id="contact-cta"
    class="scroll-mt-[var(--nav-h)] relative min-h-[calc(100svh-var(--nav-h))] md:min-h-[calc(100dvh-var(--nav-h))] pt-[calc(var(--nav-h)+2rem)] bg-[#FBFAF6] overflow-hidden">
    <div class="container mx-auto px-4 h-full flex items-center">
      <div class="text-center max-w-3xl mx-auto w-full py-16 md:py-24 mt-12 md:mt-24">
        ...
        <h1 class="text-1xl md:text-2xl lg:text-3xl font-serif font-semibold text-slate-900 mb-6"
          style="font-family: 'Playfair Display', 'Cormorant Garamond', serif; font-weight: 500;" data-aos="fade-up"
          data-aos-duration="800" data-aos-delay="100">
          Contact Us
        </h1>
        <p class="text-sm md:text-base text-slate-700 leading-relaxed mb-8" data-aos="fade-up" data-aos-duration="800"
          data-aos-delay="200">
          For bookings or more information, reach out to us with the enquiry form and our reservations team will get
          back to you as soon as possible.
        </p>
        <div data-aos="fade-up" data-aos-duration="800" data-aos-delay="300">
          <a href="https://wa.me/6287862173133" target="_blank" rel="noopener noreferrer" class="inline-flex items-center gap-2 rounded-lg bg-green-500 hover:bg-green-600 
      ...
      <div class="grid lg:grid-cols-5 gap-12 max-w-7xl mx-auto">
        ...
        <div class="lg:col-span-3" data-aos="fade-right" data-aos-duration="800">
          <h2 class="text-lg md:text-1xl font-bold text-slate-900 mb-4">
            Gita Car Rental Reservasion
          </h2>
          <p class="text-sm md:text-base text-slate-700 leading-relaxed mb-6 max-w-2xl">
            Our reservations team are always available to help. From villa bookings and travel planning to itineraries
            and experiences, our team is here to assist you.
          </p>
          ...
          <div class="grid md:grid-cols-2 gap-8 max-w-2xl">
            ...
            <div>
              ...
              <a href="https://watuganggariverside.online" target="_blank" rel="noopener noreferrer"
                class="text-base text-slate-900 hover:text-slate-700 transition-colors duration-300 block mb-6">
