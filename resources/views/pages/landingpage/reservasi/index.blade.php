                            ...
                            <div x-show="expanded" x-collapse>
                                <div class="px-5 sm:px-6 pb-6 pt-2 border-t border-gray-100 bg-gray-50/50">
                                    ...
                                    <div class="mt-4 p-4 bg-blue-50 text-blue-800 rounded-lg text-sm border border-blue-100">
                                        ...
                                        <div class="mt-1">
                                            <a href="{{ $pesanan->lokasi_url }}" target="_blank" rel="noopener noreferrer" class="text-blue-700 hover:text-blue-900 font-medium inline-flex items-center gap-1">
                                                {{ $pesanan->lokasi_url }}
                                        ...
                                        <p class="mt-1">{{ $pesanan->lokasi_deskripsi }}</p>
                                        @endif
                                    </div>
                                    @endif
                                </div>
