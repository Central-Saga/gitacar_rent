...
mount(function (KendaraanUnit $kendaraanUnit) {
    $this->unit = $kendaraanUnit;
    $this->kendaraan_id = $kendaraanUnit->kendaraan_id;
    $this->nomor_plat = $kendaraanUnit->nomor_plat;
    $this->tahun = $kendaraanUnit->tahun;
    $this->status_unit = $kendaraanUnit->status_unit;
...
$save = function() {
    $this->validate([
        ...
        'nomor_plat' => [
            ...
            'string',
            'max:20',
            Rule::unique('kendaraan_units')->ignore($this->unit->id)
        ],
    ...
    session()->flash('message', 'jumlah kendaraan berhasil diperbarui!');
...
<div class="w-full max-w-none">
            ...
            <div class="mb-10">
                <div class="flex flex-col lg:flex-row items-start lg:items-center justify-between gap-6">
                    <div>
                        <h1 class="text-2xl font-bold text-gray-900 dark:text-white">Edit Jumlah Kendaraan</h1>
                        <p class="mt-2 text-sm text-gray-600 dark:text-gray-300 font-medium">
                            Perbarui data jumlah kendaraan ({{ $unit->nomor_plat }})
                        </p>
                    </div>
