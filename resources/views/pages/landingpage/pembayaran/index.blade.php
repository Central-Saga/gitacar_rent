                    ...
                    <div class="p-8">
                        ...
                        @if($bookingData && $unit)
                            <div class="space-y-4">
                                ...
                                @if($bookingData['lokasi_url'] ?? $bookingData['lokasi_deskripsi'] ?? null)
                                <div class="mt-4 pt-4 border-t border-gray-100 space-y-3">
                                    <p class="text-xs font-bold text-textDark uppercase tracking-wider flex items-center gap-1.5">
                                    ...
                                    @if($bookingData['lokasi_url'])
                                    <div>
                                        <p class="text-xs text-textGray font-medium mb-1">Google Maps</p>
                                        <a href="{{ $bookingData['lokasi_url'] }}" target="_blank" rel="noopener noreferrer" class="text-sm text-primary hover:text-primaryDark font-semibold inline-flex items-center gap-1 break-all">
                                            {{ $bookingData['lokasi_url'] }}
                                    ...
                                    @endif
                                    @if($bookingData['lokasi_deskripsi'])
                                    <div>
                                        <p class="text-xs text-textGray font-medium mb-1">Deskripsi Lokasi</p>
                                        <p class="text-sm text-textDark">{{ $bookingData['lokasi_deskripsi'] }}</p>
                                    </div>
                                    @endif
                                </div>
                                @endif
